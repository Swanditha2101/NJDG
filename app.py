...
with col2:
   ...
   st.markdown(
        f"<div style='text-align:right; color:#475569; font-size:14px; font-weight:500;'>{now}</div>",
        unsafe_allow_html=True
    )
with col3:
...
st.markdown(f"""
<hr style="margin-top:60px; border:0; border-top:1px solid #E2E8F0;">
<div style="text-align:center; color:#94A3B8; font-size:13px; margin-top:10px;">
© {current_year} • Law & Justice • Developed by Nyayadrishti •
</div>
""", unsafe_allow_html=True)
